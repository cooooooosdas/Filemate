    ...
    >
      ...
      <div v-if="!isUploading" class="upload-content">
        <div class="upload-icon-wrap">
          <div class="upload-icon" :class="{ 'animate-bounce': zoneHovered }">
...
const handleZoneHover = () => {
  zoneHovered.value = true
}

const handleZoneLeave = () => {
  zoneHovered.value = false
}
...
const processQueue = async () => {
  ...
  try {
    ...
    const session = await uploadFile(pending.file)
